...
import IndexTables1m from "./IndexTablem";
import NeoplasmTablem from "./Neoplasmtablem";
import DrugTablem from "./Drugtablem";
...
<div className="indexcontainer">
      ...
      {showIndx && <IndexTables1m setResults1={setResults1}
      ...
      { showTable && <NeoplasmTablem setResults1={setResults1}
                  setSelectedCode={setSelectedCode}/>}
</div>
      ...
      {showDrug && <DrugTablem  setResults1={setResults1}
                  setSelectedCode={setSelectedCode}/>}
      </div>
    </div>
